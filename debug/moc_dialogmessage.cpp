...
namespace {
struct qt_meta_stringdata_DialogMessage_t {
    uint offsetsAndSizes[2];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_DialogMessage_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_DialogMessage_t qt_meta_stringdata_DialogMessage = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_DialogMessage[] = {
...
Q_CONSTINIT const QMetaObject DialogMessage::staticMetaObject = { {
    ...
    qt_meta_stringdata_DialogMessage.offsetsAndSizes,
    qt_meta_data_DialogMessage,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_DialogMessage_t,
        // Q_OBJECT / Q_GADGET
...
void *DialogMessage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DialogMessage.stringdata0))
